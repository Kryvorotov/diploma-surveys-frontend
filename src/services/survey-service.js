...
import {
  ...
  setSurvey,
  setSurveys,
} from "../redux/slices/surveysSlice";
...
export const fetchSurveys = () => async (dispatch) => {
  try {
    ...
    dispatch(
      setAlert({
        message: "Server error! Cannot get list of surveys.",
        alertType: "error",
      })
    );
  }
...
export const getSurveyById = (payload) => async (dispatch) => {
  try {
    ...
    dispatch(
      setAlert({
        message: "Server error! Cannot get survey info.",
        alertType: "error",
      })
    );
  }
...
export const getSurveyQuestions = (payload) => async (dispatch) => {
  try {
    ...
    dispatch(
      setAlert({
        message: "Server error! Cannot get list of survey questions.",
        alertType: "error",
      })
    );
  }
...
export const getSurveyComment = (payload) => async (dispatch) => {
  try {
    ...
    dispatch(
      setAlert({
        message: "Server error! Cannot get survey comments.",
        alertType: "error",
      })
    );
  }
